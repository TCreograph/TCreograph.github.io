...
export { Author, AuthorInfo, AuthorName, BasePageFrontMatter, CustomServerOptions, DateDetail, DateInfo, DateOptions, GetLocalesOptions, HTML_TAGS, HopeLang, Logger, PackageManager, PageExcerptOptions, RequiredLocaleConfig, SVG_TAGS, addChainWebpack, addCustomElement, addViteConfig, addViteOptimizeDepsExclude, addViteOptimizeDepsInclude, addViteSsrExternal, addViteSsrNoExternal, atou, compareDate, deepAssign, detectPackageManager, encodeCDATA, encodeXML, getAuthor, getBundlerName, getCategory, getDate, getDirContents, getLocalePaths, getLocales, getPageExcerpt, getPageText, getRootLang, getRootLangPath, getStringArray, getTag, getTitleFromFilename, getTypeofLockFile, hasGlobalInstallation, injectLocalizedDate, isAbsoluteUrl, isUrl, lang2Path, md2text, mergeAlias, mergeViteConfig, noopModule, path2Lang, tagHint, timeTransformer, useCustomDevServer, utoa };
