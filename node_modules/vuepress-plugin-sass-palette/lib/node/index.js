...
${c}`}}}}})}else if(p==="webpack"){const r=t;r.scss||(r.scss={});const{additionalData:n}=r.scss,u=(o,c)=>{const a=j(n)?`${n}${o}`:x(n)?n(o,c):o;return a.match(new RegExp(`@use\\s+["']@sass-palette\\/${e}-config["'];`))?a:`@use "@sass-palette/${e}-config";
