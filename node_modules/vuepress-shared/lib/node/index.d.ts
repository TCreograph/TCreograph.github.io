...
export { Author, AuthorInfo, AuthorName, BasePageFrontMatter, CustomServerOptions, DateDetail, DateInfo, DateOptions, GetLocalesOptions, HTML_TAGS, HopeLang, Logger, MATHML_TAGS, PackageManager, PageExcerptOptions, RequiredLocaleConfig, SVG_TAGS, addChainWebpack, addCustomElement, addViteConfig, addViteOptimizeDepsExclude, addViteOptimizeDepsInclude, addViteSsrExternal, addViteSsrNoExternal, atou, compareDate, deepAssign, detectPackageManager, encodeCDATA, encodeXMLContent, endsWith, entries, fromEntries, getAuthor, getBundlerName, getCategory, getDate, getDirContents, getLocalePaths, getLocales, getPageExcerpt, getPageText, getRootLang, getRootLangPath, getStringArray, getTag, getTitleFromFilename, getTypeofLockFile, hasGlobalInstallation, injectLocalizedDate, isAbsoluteUrl, isUrl, keys, lang2Path, md2text, mergeAlias, mergeViteConfig, noopModule, path2Lang, startsWith, tagHint, timeTransformer, useCustomDevServer, utoa, values };
